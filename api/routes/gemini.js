...
router.get('/', async (req, res) => {
  ...
  const model = await genAI.getGenerativeModel({
    ...
    systemInstruction: `return response in JSON format {}. You will receive a prompt from the user detailing their vacation preferences, including budget, duration, weather preferences, activities they enjoy, and any special requirements. Based on this input, generate a response suggesting a destination and providing a detailed itinerary. The response should include the following properties:
    ...
    If you are unable to provide a destination or detailed itinerary based on the user's input, suggest a random destination and itinerary. Always return a response in JSON format.`,
