    ...
    <div className="question-container">
      <div className="question">
        ...
        <h2 className="question__description">
          Describe your vacation preferences: budget, duration, weather,
          activities, and any special needs. We'll suggest a destination and
          provide a detailed itinerary.
        </h2>
        <form className="question__form" onSubmit={handleSubmit}>
          <textarea
            className="question__form__textarea"
            id="user-prompt"
            name="user-prompt"
            rows="4"
            cols="50"
